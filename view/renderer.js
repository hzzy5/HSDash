...
export class Renderer {
    ...
    async loadAssets() {
        ...
        const assets = {
            ...
            spike: "assets/bilder/StachelnKleinUnten.png",
            spikeoben: "assets/bilder/StachelnKleinOben.png",
            ...
            fahrstuhl: "assets/bilder/fahrstuhl_anim1.png",
    ...
    createSprite(alias, x, y, scale, anchorX, anchorY) {
        let sprite = PIXI.Sprite.from(alias);
        sprite.x = x;
        sprite.y = y;
